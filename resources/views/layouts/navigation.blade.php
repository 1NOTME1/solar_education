<style>
     #dark-mode-toggle {
            ...
            border: 1px solid #f9fafb; /* white border */
            border-radius: 8px;
            height: 35px;
            cursor: pointer;
            position: relative;
            ...
            margin-right: 10px; /* odstęp od sąsiedniego przycisku */
        }
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <!-- Dodaj ten przycisk -->
                <button id="dark-mode-toggle" class="bg-gray-700 text-white px-3 py-2 rounded-md text-sm font-medium theme-toggle" onclick="toggleTheme()">
                    Dark Mode
                </button>

                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-200 bg-dark hover:text-gray-400 hover:bg-gray-900 focus:outline-none transition ease-in-out duration-150">
            ...
            <div class="-mr-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-gray-200 hover:text-gray-400 hover:bg-gray-900 focus:outline-none transition duration-150 ease-in-out">
